...
('login', 'en', 'login_title', 'Login'),
('login', 'en', 'username', 'Username'),
('login', 'en', 'password', 'Password'),
('login', 'en', 'login_button', 'Login'),
('login', 'en', 'forgot_password', 'Forgot Password?'),
('login', 'en', 'register', 'Register'),
('login', 'se', 'login_title', 'Logga in'),
('login', 'se', 'username', 'Användarnamn'),
...
Ni har självklart rätt att avsluta användningen av programmet utan kostnad, genom att ge besked per email inom 14 dagar från registrering, att ni inte vill fortsätta med programmet, och betalar då självklart inte heller något.
...
('Product 2', 20.00, 25.00, 1, 25.00),
('Product 3', 12.50, 18.00, 2, 36.00),
('Product 4', 30.00, 45.00, 1, 45.00),
('Product 5', 5.50, 8.25, 5, 41.25),
('Product 6', 50.00, 75.00, 1, 75.00),
('Product 7', 22.00, 30.00, 3, 90.00),
('Product 8', 18.00, 25.00, 2, 50.00),
('Product 9', 7.00, 12.00, 10, 120.00),
('Product 10', 80.00, 110.00, 1, 110.00),
('Product 11', 14.00, 20.00, 4, 80.00),
('Product 12', 60.00, 85.00, 1, 85.00),
('Product 13', 9.00, 14.00, 3, 42.00),
('Product 14', 25.00, 35.00, 2, 70.00),
('Product 15', 42.00, 55.00, 1, 55.00),
('Product 16', 100.00, 150.00, 1, 150.00),
('Product 17', 16.00, 22.00, 5, 110.00),
('Product 18', 33.00, 40.00, 2, 80.00),
('Product 19', 8.50, 13.00, 7, 91.00),
('Product 20', 200.00, 250.00, 1, 250.00);
